...
> :warning: This downloads several large files (~20 GB total) and takes ~90 minutes to download (tested on Seqera Cloud). See the wiki page for how to prepare individual PopPUNK databases. 
```
